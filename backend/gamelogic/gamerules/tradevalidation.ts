...
import { GameState, resourcesCards, Trade, TradeState, TradeRequest } from "../../../utils/type";

export function checkSenderTradeRequest(TradeRequest: TradeRequest, game: GameState): boolean { return true; }
...
export function checkReceiverTradeRequest(TradeRequest: TradeRequest, game: GameState): boolean { return true; }
